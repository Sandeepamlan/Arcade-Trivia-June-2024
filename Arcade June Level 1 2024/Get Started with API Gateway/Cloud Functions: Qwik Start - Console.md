...
exports.GCFunction = (req, res) => {
    let message = req.query.message || req.body.message || 'Copy from Sandeep';
...
DATA=$(printf 'Copy from Sandeep Palai' | base64) && gcloud functions call GCFunction --region=$REGION --data '{"data":"'$DATA'"}'
